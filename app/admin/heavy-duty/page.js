...
const API_ROUTE = "/api/admin/heavy-duty";
...
export default function HeavyDutyPage() {
    ...
    async function loadLeaf(saeGradeId, productId) {
        ...
        const [acea, allAcea, oem, allOem] = await Promise.all([
    ...
    async function handleAdd(type) {
        try {
            ...
            if (["acea", "oem"].includes(type) && (!selectedSaeGrade || !selectedProduct)) {
            ...
            <div className="mt-2 rounded-lg border border-blue-100 bg-blue-50/60 p-2">
                <div className="mb-2">
                    ...
                    <p className="text-[11px] leading-4 text-gray-500">
                        Product list is filtered by published status and Heavy Duty /HDDEO category.
                    </p>
                </div>
