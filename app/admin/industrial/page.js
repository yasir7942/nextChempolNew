...
const API_ROUTE = "/api/admin/industrial";
...
export default function IndustrialPage() {
    ...
    function showError(error) {
        console.log("[industrial page] error:", error);
    ...
    async function fetchJson(url, options = {}) {
        ...
        try {
            ...
            console.log("[industrial page] JSON parse error:", error);
            console.log("[industrial page] response text:", text);
