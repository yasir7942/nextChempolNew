...
const API_ROUTE = "/api/admin/speciality";
...
export default function SpecialityChemicalsPage() {
    ...
    function showError(error) {
        console.log("[speciality page] error:", error);
    ...
    async function fetchJson(url, options = {}) {
        ...
        try {
            ...
            console.log("[speciality page] JSON parse error:", error);
            console.log("[speciality page] response text:", text);
    ...
    async function loadTypes() {
        setTypes(enumToOptions(ENUMS.SpecialityType || []));
    }
                ...
                <div className="mb-2 flex items-center justify-between gap-2">
                    <div>
                        ...
                        <p className="text-[11px] leading-4 text-gray-500">
                            Product list is filtered by published status and Speciality Chemicals category.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-3 lg:grid-cols-[1fr_320px]">
                        ...
                        <aside className="h-fit rounded-xl border border-gray-200 bg-white p-3 shadow-sm lg:sticky lg:top-4">
                            ...
                            <div className="mt-3 rounded-lg border border-blue-100 bg-blue-50 px-3 py-2 text-xs text-blue-700">
                                Type dropdown loads from enums.json variable SpecialityType.
                            </div>
                        </aside>
