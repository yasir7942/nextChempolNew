...
const DisaplyFrontVideos = ({ VideoData, latestRelasetext }) => {
    ...
    return (
        <div className="overflow-x-auto font-serif">
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-7 mt-6">
