            ...
            <div className="flex flex-col w-full z-10 justify-center items-center text-4xl font-bold">
              ...
              <div className="flex mt-6 text-white items-center justify-center space-x-4">
                ...
                <div>
                  <a
                    href="/contact/"
                    className="bg-[#001a35] border border-textLightBlue hover:bg-textLightBlue hover:text-[#001a35] text-textLightBlue uppercase px-2 py-2 font-semibold text-sm rounded-md transition duration-300 ease-in-out"
                  >
